...
<main class="py-8 flex justify-between">
  ...
  <div class="w-1/2 bg-gray-100 p-6 rounded-lg border-2 border-dashed border-gray-300">
    ...
    <form class="space-y-4">
      ...
      <button type="submit" on:click={handleSignup} class="w-full bg-blue-600 text-white font-bold py-3 rounded hover:bg-blue-700">Start Making Money</button>
    </form>
  </div>
</main>